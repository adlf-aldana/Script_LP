/* EXTRACTO CAJA DE AHORRO CON DESCRIPCION DE LA CATMV */-- 19/08/2020  --DEBE/HABER ACTUALIZADOS
select b.camcancta Cuenta,c.catrnftra fecha,c.catrnhora hora,c.catrnagen agencia,d.catmvdesc descrip,
round(decode(c.catrnimpo,(select e.catrnimpo
					      ...
					      and catrnimpo>=0),c.catrnimpo,(select e.catrnimpo
					                                     ...
					                                     and e.catrnntra=c.catrnntra
					                                     and e.catrnstat=0
					                                     and catrnimpo<0),c.catrnimpo*0),2) debe,
round(decode(c.catrnimpo,(select e.catrnimpo
					      from catrn e
					      where e.catrnncta=c.catrnncta
					      and e.catrnpref=c.catrnpref
					      ...
					      and catrnimpo>=0),c.catrnimpo*0,(select e.catrnimpo
					                                       ...
					                                       and e.catrnntra=c.catrnntra
					                                       and e.catrnstat=0
					                                       and catrnimpo<0),c.catrnimpo*-1),2) haber,(b.camcasact*-1) saldo,
c.catrnntra Nro_Trans,c.catrnuser user,d.catmvpref pref,d.catmvcorr corr
...
and b.camcancta=3051920851  --3051865570 --3051863429
and c.catrnftra between '2020-07-01' and '2022-03-31'
and c.catrnstat=0
order by 2,3,9;
