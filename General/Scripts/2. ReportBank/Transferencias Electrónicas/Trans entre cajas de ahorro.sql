SELECT e.catmvdesc TIPO_TRANSACCION, 
	c.catrnndoc NRO_TRANSACCION, 
	b.camcancta CTA_ORIGEN, 
	a.gbagenomb TITULAR_ORIGEN,
	tetrnnctx CTA_DESTINO, 
	f.tetrnnomx TITULAR_DESTINO, 
	c.catrnftra FECHA, 
	c.catrnhora HORA,
	round(sum(c.catrnimpo),2) MONTO, 
	c.catrncmon MONEDA, 
	f.tetrnuser USUARIO, 
...
and b.camcastat=1
and c.catrnftra between '2022-01-01' and '2023-01-31'
and (c.catrnimpo)>0
and c.catrnpref=10
...
select e.catmvdesc TIPO_TRANSACCION, 
	c.catrnndoc NRO_TRANSACCION, 
	tetrnnctx CTA_ORIGEN, 
	f.tetrnnomx TITULAR_ORIGEN,
	b.camcancta  CTA_DESTINO, 
	a.gbagenomb TITULAR_DESTINO,
	c.catrnftra FECHA,
	c.catrnhora HORA,
	round(sum(c.catrnimpo*-1),2) MONTO,
	c.catrncmon MONEDA, 
	c.catrnuser USUARIO, 
	adaudausr AUTORIZADOR
from gbage a,camca b,catrn c,catca d,catmv e, tetrn f, outer adaud g
...
and a.catrnftra between '2022-01-01' and '2023-01-31'
